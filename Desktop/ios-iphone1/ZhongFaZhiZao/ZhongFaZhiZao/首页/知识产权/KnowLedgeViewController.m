...
- (void)viewDidLoad {
    ...
    NavigationControllerView *navView = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andLeftBtn:@"知识产权专利"];
...
- (void)createHeader{
    ...
    self.headerView = [[UIView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight, screenWidth, screenWidth/375.0*145+46*3+51)];
