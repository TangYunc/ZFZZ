...
- (void)createNavgationView {
    ...
    self.pushSerchBtn.frame = CGRectMake(59*screenScale,(SafeAreaTopHeight - 40), 539/2.0*screenScale, 59/2.0);
...
//    [self.view addSubview:self.pushSerchBtn];
    ...
    pushBtn.frame = CGRectMake(screenWidth-20*screenScale-14*screenScale, (SafeAreaTopHeight - 40)+(59/2.0-24)/2.0, 20*screenScale, 27);
