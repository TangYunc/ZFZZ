...
- (void)viewDidLoad {
    ...
    _scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight+11, screenWidth, screenHeight-SafeAreaTopHeight-11-SafeAreaBottomHeight)];
...
//  申请
    ...
    applyBtn.frame = CGRectMake(0, screenHeight-53-SafeAreaBottomHeight, screenWidth, 53);
