...
- (void)viewDidLoad {
    ...
    NavigationControllerView *nav = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andLeftBtn:@"产品详情"];
    nav.viewController = self;
    [self.view addSubview:nav];
    self.view.backgroundColor = BACK_COLOR;
    
    _scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight, screenWidth, screenHeight-SafeAreaTopHeight-SafeAreaBottomHeight)];
...
//    放在window层上
    UIView *downLeftView = [[UIView alloc]initWithFrame:CGRectMake(0, screenHeight-52-SafeAreaBottomHeight, 477/2.0*screenScale, 52)];
...
//    申请按钮
    ...
    applyBtn.frame = CGRectMake(477/2.0*screenScale, screenHeight-53-SafeAreaBottomHeight, screenWidth-477/2.0*screenScale, 53);
...
//    在线咨询
    ...
    askBtn.frame = CGRectMake(screenWidth-97*screenScale, screenHeight-53-24-32*screenScale-SafeAreaBottomHeight, 97*screenScale, 32*screenScale);
