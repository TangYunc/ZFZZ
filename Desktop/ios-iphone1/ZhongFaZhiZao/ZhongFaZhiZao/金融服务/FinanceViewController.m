...
- (void)viewDidLoad {
    ...
    NavigationControllerView *navView = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andLeftBtn:@"金融服务"];
...
- (void)createHeadView{
    ...
    _headerView = [[UIView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight, screenWidth, 143*screenScale+53)];
