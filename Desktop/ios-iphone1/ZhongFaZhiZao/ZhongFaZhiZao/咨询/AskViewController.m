...
- (void)viewDidLoad {
    ...
    NavigationControllerView *navView = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andLeftBtn:@"消息中心"];
    navView.viewController = self;
    [self.view addSubview:navView];
    
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(12*screenScale, SafeAreaTopHeight, screenWidth-12*screenScale*2, screenHeight-SafeAreaTopHeight) style:UITableViewStylePlain];
