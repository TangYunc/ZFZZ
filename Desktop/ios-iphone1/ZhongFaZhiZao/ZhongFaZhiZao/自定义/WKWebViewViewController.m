...
- (void)viewDidLoad {
    ...
    // Do any additional setup after loading the view.
     ...
     navView = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andLeftBtn:_navigatorTitle];
...
//    创建webview
    ...
    _webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, SafeAreaTopHeight, screenWidth, screenHeight-SafeAreaTopHeight - SafeAreaBottomHeight)configuration:config];
