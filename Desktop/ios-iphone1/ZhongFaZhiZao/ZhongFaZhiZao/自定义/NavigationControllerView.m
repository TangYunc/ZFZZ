...
//        leftBtn.backgroundColor = [UIColor redColor];
        ...
        _midLabel.center = CGPointMake(screenWidth/2.0, SafeAreaTopHeight - 22);
...
//        navView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"NavBG"]];
        ...
        midLabel1.center = CGPointMake(screenWidth/2.0, SafeAreaTopHeight - 22);
        ...
        rightBtn.center = CGPointMake(screenWidth-21-20, SafeAreaTopHeight - 22);
