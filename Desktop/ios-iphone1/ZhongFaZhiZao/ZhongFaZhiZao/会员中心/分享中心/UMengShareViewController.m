...
- (void)viewDidLoad {
    ...
    NavigationControllerView *view = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andLeftBtn:@"分享"];
    view.viewController = self;
    [self.view addSubview:view];
    
    self.btnFlag = 0;
    
    self.scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight, screenWidth, screenHeight)];
