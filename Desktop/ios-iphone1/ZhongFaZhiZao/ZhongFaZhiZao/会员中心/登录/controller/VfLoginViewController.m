...
- (void)viewDidLoad {
    ...
    NavigationControllerView *navView = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andRightBtn:@"动态密码登录"];
    navView.viewController = self;
    
    [self.view addSubview:navView];
    
    self.vfLoginView =[[VfLoginView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight, screenWidth, screenHeight-SafeAreaTopHeight)];
