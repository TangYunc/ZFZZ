...
- (void)viewDidLoad {
    ...
    NavigationControllerView *navView = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andLeftBtn:@"注册"];
    navView.viewController = self;
    
    [self.view addSubview:navView];
    
    self.registView = [[RegisterView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight, screenWidth, screenHeight-SafeAreaTopHeight)];
