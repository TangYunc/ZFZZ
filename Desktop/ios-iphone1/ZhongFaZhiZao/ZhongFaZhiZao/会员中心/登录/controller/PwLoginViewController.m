...
- (void)viewDidLoad {
    ...
    NavigationControllerView *navView = [[NavigationControllerView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, SafeAreaTopHeight) andRightBtn:@"会员登录"];
...
//    self.pwLoginView =[[PwLoginView alloc]initWithFrame:[UIScreen mainScreen].bounds];
    self.pwLoginView = [[PwLoginView alloc]initWithFrame:CGRectMake(0, SafeAreaTopHeight, screenWidth, screenHeight-SafeAreaTopHeight)];
